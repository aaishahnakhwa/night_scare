...
export const ReadingHub: React.FC = () => {
      ...
      <div className="max-w-4xl w-full z-20 flex flex-col">
        ...
        <div className="mb-12">
          ...
          <p className="font-special text-xs text-stone-500 tracking-wider mt-2 uppercase">
            Select a narrative. Let the walls speak.
          </p>
        </div>
          ...
          {readingStories.map((story, i) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col">
                <BookOpen size={24} className="text-horror-red mb-3 filter drop-shadow-[0_0_5px_rgba(153,27,27,0.5)]" />
